...
export default function Footer() {
    return (
        <footer id='footer' className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    ...
                    <a href="https://www.linkedin.com/in/geet-talati-868851285/" target="_blank" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://x.com/" target="_blank" rel="noreferrer">
                        <TwitterIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://www.youtube.com/@geettalati9409" target="_blank" rel="noreferrer">
                        <YoutubeIcon className="size-6 hover:text-pink-500" />
                    </a>
                </div>
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} Thumblify - AI Generator App</p>
            </motion.div>
        </footer>
    );
}