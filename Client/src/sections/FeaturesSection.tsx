            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your views with AI generated design. </h3>
                        <p className="text-slate-300 mt-2">Stop guessing and start ranking.Our AI designs proven to capture attention </p>
